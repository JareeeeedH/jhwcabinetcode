    ...
    export default {
        ...
        methods: {
            getProducts(page=1) {
                ...
                const api = `https://vue-course-api.hexschool.io/api/jwcabinet/products?page=${page}`;
                const vm = this;
            ...
            addProduct() {
                ...
                let api = `https://vue-course-api.hexschool.io/api/jwcabinet/admin/product`;
                let httpMethod = 'post'
                const vm = this;

                if (!vm.adding_item) {

                    api = `https://vue-course-api.hexschool.io/api/jwcabinet/admin/product/${vm.tempProduct.id}`;
                    httpMethod = 'put';
            ...
            delProduct() {
                const vm = this;
                const api = `https://vue-course-api.hexschool.io/api/jwcabinet/admin/product/${this.tempProduct.id}`
            ...
            uploadFile() {
                ...
                const url = `https://vue-course-api.hexschool.io/api/jwcabinet/admin/upload`;
