...
import $ from 'jquery'
    ...
    export default {
        ...
        methods: {
            ...
            getCoupons(page = 1) {
                this.isLoading = true;
                const api = `https://vue-course-api.hexschool.io/api/jwcabinet/admin/coupons?page=${page}`;
                const vm = this;
            ...
            addCoupon(id) {
                ...
                //預設 情況；
                let ApiMethod = 'post'
                let api = `https://vue-course-api.hexschool.io/api/jwcabinet/admin/coupon`;
                const vm = this;

                // 如果是要修改；則修改 method& Api路徑。
                if (this.addingCoupon == false) {
                    ApiMethod = 'put';
                    api = `https://vue-course-api.hexschool.io/api/jwcabinet/admin/coupon/${id}`;
                }
            ...
            DelCoupon() {
                ...
                const api = `https://vue-course-api.hexschool.io/api/jwcabinet/admin/coupon/${this.coupon_new.id}`;
                const vm = this;
